function toggleSideMenu() {
  ...
  const popUpText = document.querySelector(
    ".hero .pop-up .side-menu-pop-up .side-menu-text-container",
  );
  const popUpImage = document.querySelector(
    ".hero .pop-up .side-menu-pop-up .side-menu-image-container",
  );
...
(function () {
  ...
  const sideMenuOverLay = document.querySelector(
    ".hero .pop-up .side-menu-overlay",
  );
